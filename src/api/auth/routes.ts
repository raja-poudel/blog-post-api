...
import { handleSignIn, handleToken, handleSignUp, handleProfile, handleChangePassword, handleResetPassword, handleGetByPaginate, handleUser, handleCreateUser, handleUpdateUser, handleDeleteUser } from './handlers'
